# Especificacao Tecnica — Java Spring Boot Crud

| Field | Value |
|---|---|
| Repository | `java_spring_boot_crud_project` |
| Language | Java (Maven / JUnit 5) |
| Versao | 1.0 |
| Status | Ativo |

## 1. Objective and escopo

Registration service (CRUD) with persistence, validation, and REST API. This document describes requirements, architecture, and acceptance criteria.
...
Follows the scaffold idiomatico of Java: code-fonte, tests and manifesto of build
...
- [ ] `mvn clean install` conclui without errors.
- [ ] `mvn exec:java` executa the componente.
- [ ] `mvn test` passa (CI green, coverage 100%).

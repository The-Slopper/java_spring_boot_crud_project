...
| Campo | Valor |
|---|---|
| Repositorio | `java_spring_boot_crud_project` |
...
Servico de cadastro (CRUD) com persistencia, validacao e API REST. Este documento descreve requisitos, arquitetura e criterios de aceite.
...
Segue o scaffold idiomatico de Java: codigo-fonte, testes e manifesto de build
...
- [ ] `mvn clean install` conclui sem erros.
- [ ] `mvn exec:java` executa o componente.
- [ ] `mvn test` passa (CI verde, cobertura 100%).
